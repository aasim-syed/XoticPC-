...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <div class ="center-page">
        ...
        <div class ="col-xs-11">
        <asp:TextBox ID="TextBox3" runat="server" Class = "form-control" placeholder ="Enter your email id"></asp:TextBox>
        </div>

        <label class="col-xs-11">Password:</label>
        <div class ="col-xs-11">
        <asp:TextBox ID="TextBox4" runat="server" Class = "form-control" TextMode = "Password" placeholder ="Enter your password"></asp:TextBox>
        </div>
