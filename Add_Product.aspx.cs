...
public partial class Add_Product : System.Web.UI.Page
{
    ...
    protected void Addproduct_Click(object sender, EventArgs e)
    {
        ...
        {
            string SavePath = Server.MapPath("~/ProductImages/") + n;
    ...
    protected void ddl2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        scon.ConnectionString = "Data Source=AJITH\\SERVER;Initial Catalog='Xotic PC';Integrated Security=True";



        scon.Open();
        SqlCommand cmd = new SqlCommand("select * from SubCategory where maincatid = '" + MainCategoryID + "'", scon);
